...
//           style={{
//             backgroundImage: `url(${banner.bannerImage.node.sourceUrl})`, // Dynamically set the background image
//           }}
//         >
//           <div className="w-1206 mx-auto flex items-center justify-between">
//             <div>
//               <h2 className="font-bold text-[50px] text-white w-[265px] h-[110px] leading-[55px]">
//                 {banner.bannersTitle} {/* Dynamically display banner title */}
//               </h2>
//               <p className="text-base text-white mt-4 mb-[23px] font-lato">
//                 {banner.bannerDescription} {/* Dynamically display banner description */}
//               </p>
//               <Button
//                 href={banner.bannerButton.url} // Dynamically set button link
//                 target={banner.bannerButton.target} // Dynamically set button target
//                 className="bg-white text-[#0060AF] font-semibold text-[12px] transition transform hover:-translate-y-1"
//               >
//                 {banner.bannerButton.title} {/* Dynamically display button text */}
//               </Button>
//             </div>
//             <div className="flex flex-col items-center space-y-2">
//               <div className="w-1 h-[21px] rounded-full bg-white opacity-15"></div>
